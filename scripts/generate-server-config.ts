...
function generateConfig(): Config {
  return {
    ...
    products: [
      ...
      generateProduct({ image: 'https://images.unsplash.com/photo-1544787219-2c5077fcfcf1?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=871&q=80' }),
      ...
      generateProduct({ image: 'https://images.unsplash.com/photo-1413745094207-a01b234cc32f?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1032&q=80' }),
      // Tea
...
function generateCategory({ name = EMPTY_STRING, isArchived = false }: Partial<Category>): Category {
  return { name, isArchived };
}

function generateProduct({ image: photo = EMPTY_STRING, isArchived = false }: Partial<Product>): Product {
